          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-dark " href="#">
                ...
                <span class="nav-link-text ms-1">Заказчики</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-dark " href="#">
            ...
            <li class="nav-item mt-3">
              <h6 class="ps-4 ms-2 text-uppercase text-xs text-dark font-weight-bolder opacity-8">Меню</h6>
            </li>
            <li class="nav-item">
              <a class="nav-link text-dark " href="{{ route('admin.dishes.index') }}">
                <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">person</i>
                </div>
                <span class="nav-link-text ms-1">Блюда</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-dark " href="{{ route('admin.groups.index') }}">
                <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
