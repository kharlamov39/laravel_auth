...
<div class="modal-content">
  ...
  <div class="modal-footer">
    <button type="button" class="btn bg-gradient-secondary" id="cancel-delete" data-bs-dismiss="modal">Отмена</button>
    <button type="button" class="btn bg-gradient-primary" id="confirm-delete">Да, удалить</button>
  </div>
</div>
</div>
</div>
